...
if __name__ == '__main__':
    ...
    print('load data for 10-fold-cv')
    ...
    for train_index, test_index in kf.split(data):
        ...
        eval_data = data.iloc[test_index]
        ...
        predicted_eval_data.append(eval_data)

        fold += 1

    predicted_eval_data = pd.concat(predicted_eval_data)
    predicted_eval_data.to_csv('classifier_preds/scibert_cv_predictions_new.tsv', index=False, sep='\t')